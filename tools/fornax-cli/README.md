...
```sh
pipx install \
  "git+https://github.com/tacticaldoll/fornax.git@v0.2.0#subdirectory=tools/fornax-cli"
...
```sh
pipx run \
  --spec "git+https://github.com/tacticaldoll/fornax.git@v0.2.0#subdirectory=tools/fornax-cli" \
  fornax deploy --all
```
...
```sh
uvx \
  --from "git+https://github.com/tacticaldoll/fornax.git@v0.2.0#subdirectory=tools/fornax-cli" \
  fornax deploy --all
```
