...
```sh
pipx install \
  "git+https://github.com/tacticaldoll/fornax.git@v0.4.1#subdirectory=tools/fornax-cli"
...
```sh
uvx \
  --from "git+https://github.com/tacticaldoll/fornax.git@v0.4.1#subdirectory=tools/fornax-cli" \
  fornax deploy --all
```
