...
The block lives in docs/record-contracts.md between the SEAM-INVENTORY markers.
...
from agent_skill_format.markdown_links import heading_texts, marked_code_blocks
...
CONTRACT = Path("docs/record-contracts.md")
