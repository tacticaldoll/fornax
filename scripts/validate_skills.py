...
def undeclared_directories(name: str, boundary: Boundary, declared_roots: set[str]) -> bool:
    ...
    against two trees on the day it was written, and the measurement belongs in a dated
    reference rather than here — a docstring has no date, so a reading of a tree put in one
    stops being true without
